...
class UserSelector {
    ...
    constructor(config) {
        ...
        // Selected users are tracked within the current page session only.
        // After a form submit (page reload) the modal always starts fresh.
        this.selectedUsers = {};
    ...
    async createModal() {
        ...
        this.modal = await ModalSaveCancel.create({
            title: title,
            body: body,
            large: true,
            buttons: {
